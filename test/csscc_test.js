...
exports.csscc = {
    ...
    clean_css_import: function(test) {
        test.expect(1);

        var expect = grunt.file.read('test/expected/clean_css_import.css');
        var result = grunt.file.read('tmp/clean_css_import.css');
        test.equal(expect, result, 'has clean-css 2.0.x import issue');
